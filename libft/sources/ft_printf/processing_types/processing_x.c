...
/*   Updated: 2021/01/29 17:07:25 by anonymous        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
															...
															va_list arg_ptr)
{
	...
	if (!(converted_value = ft_pf_itoa_base(value, base)))
		return ;
	placeholder->type == 'X' ? ft_strtoupper(converted_value) : converted_value;
